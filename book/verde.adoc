...
The consequences of preparing food to order come in the form of scale and efficiency.  It limits the number of people that can be served (rate of sale)

On it's face, to say that a food was not prepared to order seems to suggest that the restaurant failed to prepare itself it bears is important to  about what is being implied 
