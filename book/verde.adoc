...
Thus, the convenience of obtaining an off-season ingredient from a distributor comes at an added cost, which is in turn passed on to the consumer.  Moreover, this cost fluctuates throughout the year. __doesn't mean that they are insulated from price fluctuations__.  Ultimately, the additional costs and their inherent volatility discourage the use of fresh produce in a static menu.

Neither is the trouble over once the produce is in hand.  Spoilage is a big factor in restaurants and the static menu prevents changing the menu nor the price, leaving restaurants with little means to combat impending spoilage and further discouraging incorporation of fresh produce in the menu.

== Plan to fail

Another common characteristic of the food service industry is prepared-to-order food.  Before going on to discuss the impact of this, it's implicit meaning must be stated.  Criticism of prepared-to-order food is not suggesting that there is an overlooked opportunity to prepare dishes in advance.  The issue is that the foods chosen for the menu __cannot__ be prepared in advance otherwise they will deteriorate in quality.  Therefore, it is a criticism of the menu planning, a core component of the business model itself. 

The consequences of preparing food to order come in the form of scale and efficiency.  It limits the number of people that can be served (rate of sale) because each dish must be prepared individually no matter how many customers are waiting.  This contrasts sharply with Compare this to a dish that can be prepared in advance and it is appThis also drives up the labor costs because while food that can be prepared in advance  prevents the operation some foods can be prepared in large quantities  vulnerable to waste of from dishes going cold. It increases the labor costs of the 
