...
The opening of the book noted the relationship between food and important health and environmental issues of our time.  Later sections will delve deeper into this but for the present it is sufficient to note that most of our issues relate to our consumption (or lack thereof) of fruits and vegetables.

Therefore, in the following examination of the static menu, the foremost place to start is its relation to fresh produce.
