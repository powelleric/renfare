...
Amazingly, the new paradigm flips all of this on its head, turning what was once a liability into an asset.  The turning point of this transformation  __catalyst of this dramatic change__ __this dramatic change stems from__ is the ability of farmers to directly supply restaurants __rather than via distributors__.  This is made possible because a restaurant in the new paradigm has the capability of processing and serving enormous quantities of fresh produce.  __is streamlined in critical respects allowing it to In the existing food service industry__,Whereas the average restaurants would be hopeless if given a truckload of a random seasonal vegetable, the new paradigm of food service allows tailoring the menu to specific ingredients and the streamlined operation offers significant opportunity for savings in preparation.   meal will come at a significant discount compared to the average meal today. But

The importance of the connection between food-service and the farmer cannot be overstated.  Indeed, nearly everything in the remaining book hinges on it.  The closer the relationship that can be forged between these two parties, the more benefits there are to be reaped.

The most immediate benefit of this relationship is in the cost of the goods themselves. In today's food system, nearly 60 cents of every dollar spent on produce is accounted for by the distributors/integrators. This leaves an enormous margin to be redistributed amongst the remaining stakeholders of the paradigm. And while it is true that certain costs once born by the distributor, such as transportation, must now be paid from this margin, these costs do not account for nearly the full amount.  Furthermore, these costs are not fixed. Transactions with local farmers may have significantly reduced transport costs, for example.

While notable, pricing is one of the most superficial benefits.  Far more profound benefits are to be found by reimagining the nature of farming in the context of the new food service paradigm.  On that note, one of the most fundamental questions is what should be grown.  This rather basic question hints at a subtle but important observation of the current food system: that what is grown currently is influenced by the distributors and is not necessarily in the best interest of the other stakeholders, sometimes even directly leading to their detriment.  This is driven by the basic nature of the distributors' business model, a model that closely mirrors that of other industrial distribution.  This model is designed to increase the scale of production of a standardized commodity.  But, as noted once already, food is not like other commodities.  that seeks to co desire of isn't necessarily in the interest of first things to ask is serves as a powerful angle 

In keeping with the theme of this section
However, this 
is also of this will need to be allocated towards services that the distributors once altered balance of power in their respective transactions.  
...
with  the restaurant key component in this tipping point in this shift is when the restaurant is
...
However, the Although, It is another thing to 
