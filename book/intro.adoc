...
The popularity of the static menu is because it facilitate a simple business strategy, specializing in a handful of dishes. The inventory and the recipes are always the same and customers know what to expect. It makes the business manageable at a very small scale, even with just a single person.
...
The previous section examined common restaurant characteristics and their shortcomings in regards to efficiency and use of produce. If these practices are changed, it would allow for a higher-volume of sales and could more effectively incorporate fresh produce into the menu. This section explores how these changes would also open new opportunities in the supply chain.

When the static menu was introduced, the distinction between globally sourced produce versus locally grown produce was made.  I also emphasized that a given ingredient would only be available locally for part of the year.  This made it seem as though the locally grown produce would be an obvious choice that time of year, but in practice even that is not so. 
...
Thus far, discussion has been centered on the economics of a food service establishment. This was intended to show the possibilities for quick, cheap and healthy food at a fundamental level.
...
The farmer was introduced in the context of the static menu and it was noted that the transaction costs made farmer-direct produce minimal. What was not mentioned is that high transaction costs are also incurred by the farmer. Essentially, it requires the farmer to take on many of the roles that distributors play in terms of sales, delivery, etc. 
...
growers would be incentivized to invest in sales and inventory systems as much or more.  would push are faced with challenging market conditions 

, that is a shared experience of the farmer

the business towards a  the adoption of fresh produce just as easily have been applied towards 
We would expect that  It would mean that  It would greatly increase the fresh produce intake for the average person's meal, a long sought goal.be a significant achievement in dietary goals The average meal in the old paradigm is heavy on carbohydrates and proteins and the It means that a large proportionThe fact that a restaurant could incorporate that quantity into their meals was taken as a prerequisite. However, this is a notable achievement in and of itself.
