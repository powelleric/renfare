...
With backing from industry-giants like General Mills to renowned-institutions like Yale University, it is widely recognized that it has the potential to remedy so many of the issues plaguing conventional agriculture. The one problem is figuring out who is going to buy the outputs.
...
The new food service paradigm offers a unique solution to both of the challenges RA faces with downstream markets. As noted previously, selling directly to food service, rather than to a distributor opens up huge margins for the farmer. Likewise, the specialty crops can expect a much warmer reception from food service in the new paradigm as restaurants seek to diversify their offerings and lure customers with "exotic" seasonal ingredients.
