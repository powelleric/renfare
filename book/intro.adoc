...
Within this context, it is obvious that having a constant price for the dishes perfectly completes the model.  It would be a shame if a customer came for their favorite dish only to find that it was too expensive that day. Furthermore, it is natural for the customer to expect the same item to cost the same thing from day-to-day; Most goods behave in this manner.
...
Therefore, to achieve the final piece of the static menu business model, a consistent price, fresh produce is marginalized because it represents financial risk and complexity. 

=== Always in stock

The situation gets worse when we compare fresh produce to meat and grains in terms of preparation.

The nail in the coffin is perishability.

Another hallmark of the static menu business model is that all items are always in stock. It may even give the impression of a poorly run establishment if menu items are sold out.  Therefore, if you wish to keep all items in stock, you must always have adequate inventory for your highest sales.  This is not a may be no problem at all

 If these practices are changed, it would allow for a higher-volume of sales and could more effectively incorporate fresh produce into the menu. 
...
Without distributors, sellers and buyers would be faced with huge transaction costs and farmers would face tremendous business pressure to develop improved distribution systems. Distributors fulfill this need and allow the farmer to focus on food production and the chef to focus on food service.  This could be described as specialization and is generally a good thing in economies.
  ...
  It would greatly increase the fresh produce intake for the average person's meal,  The average meal in the old paradigm is heavy on carbohydrates and proteins It means that a large proportion. The fact that a restaurant could incorporate that quantity into their meals was taken as a prerequisite. However, this is a notable achievement in and of itself.
