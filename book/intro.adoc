...
Another hallmark of the static menu business model is that all items are always in stock. It may even give the impression of a poorly run establishment if menu items are sold out.  Therefore, if you wish to keep all items in stock, you must always have adequate inventory for your highest sales.  This is not a may be no problem at all
 ...
 While compelling, the benefits of marginal-cost and efficiency that occur between the restaurant and the consumer are only a fraction of the benefits to be found upstream of the restaurant. 
...
In addition to the economics, this opens the possibility for other important benefits, benefits that accrue to society at large in the form of positive externalities. 
...
be working with a distributor and thetransaction costs can often be very high.  Compared to a food distributor, the time required to coordinate an order with a local grower can be 

By contrast, distributors provide an extremely convenient one-stop-shop.
