...
Amazingly, the new paradigm flips all of this on its head, turning what was once a liability into a strength.  The turning point of this transformation  __catalyst of this dramatic change__ __this dramatic change stems from__ is the ability of farmers to directly supply restaurants __rather than via distributors__.  This is made possible because a restaurant in the new paradigm has the capability of processing and serving enormous quantities of fresh produce.  __is streamlined in critical respects allowing it to In the existing food service industry__,Whereas the average restaurants would be hopeless if given a truckload of a random seasonal vegetable, the new paradigm of food service allows tailoring the menu to specific ingredients and the streamlined operation offers significant opportunity for savings in preparation.  
...
While notable, pricing is one of the most superficial benefits.  Far more profound benefits are to be found by re-imagining the nature of farming in the context of the new food service paradigm.  On that note, one of the most fundamental questions is: what should be grown?

This rather basic question alludes to an important observation about the current food system: that what is grown is influenced by the distributors and is not necessarily in the best interest of the other stakeholders, sometimes much to their detriment.  This is driven by the basic nature of the distributors' business model, a model that closely mirrors that of other industrial distribution.  This model is designed to increase the scale of production of a standardized commodity.  But, as noted once already, food is not like other commodities.

In the never-ending pursuit of more standardized agricultural commodities, the following negative practices have become endemic in conventional agriculture: "single crop production, heavy use of synthetic fertilizers and pesticides, and intense tillage" <<confi>>.  These techniques can swiftly and reliably transform the landscape into a highly productive (and profitable) fields.  However, in a long-term these techniques often ravage the native ecosystem and can result in a precarious livelihood for the farmer.
...
[[[confi]]]  The State of Regenerative Agriculture: Growing With Room to Grow More. Cortney Ahern Renton, Claire Huntley Lafave, Kathryn Sierks.  March 24, 2020. https://conservationfinancenetwork.org/2020/03/24/the-state-of-regenerative-agriculture-growing-with-room-to-grow-more
